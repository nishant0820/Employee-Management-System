...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _logout() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs
        .clear(); // Clears all saved user session data including auth_token
              ...
              SizedBox(
                ...
                child: GradientButton(
                  ...
                  onPressed: () {
                    ...
                    _logout(); // Proceed to logout/switch
                  },
                ),
              ),
            ],
      ...
      child: Column(
        ...
        children: [
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: _showSwitchProfileModal,
                      ),
                    ],
                  ),
          ...
          _SettingsTile(
            ...
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => const PortalSettingsScreen()),
              );
            },
          ),
          const SizedBox(height: 16),
            ...
            child: Column(
              children: [
                ...
                SwitchListTile(
                  ...
                  subtitle: const Text(
                    'Use fingerprint/face unlock on this device',
                  ),
                  onChanged: (value) {
